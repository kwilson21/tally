	...
	return (
		<Group id="rows" title="Rows">
			...
			>
				...
				<State label="Adjusting: a round amount, one between round $10s, over budget, and $0 (− is off)">
